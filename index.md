...
| 8 | [바이브코딩 UI](./08-vibecoding-ui/) | 웹 기본 원리와 UI 용어를 이해하고 간단한 홈페이지를 만드는 기초 실습 |
| 9 | [앞으로 진행할 활동](./09-next-activities/) | 수업 후 4주 학습 루틴, 공식 참고자료, YouTube 추천, PBT·오픈채팅 활용법 |
...
- 본 사이트는 환경·하네스 구조·Harness-Lab·영감 사례·AX 과제 브리프·바이브코딩 UI 실습·수업 후 활동 등 참고 정보를 모은 자료
